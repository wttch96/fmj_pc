...
public class ScriptProcess {
  ...
  public static int get4BytesInt(byte[] data, int start) {
    return ((int) data[start] & 0xFF)
        | ((int) data[start + 1] << 8 & 0xFF00)
        | ((int) data[start + 2] << 16 & 0xFF0000)
        | ((int) data[start + 3] << 24);
  }
  ...
  public ScriptExecutor getScriptExecutor() {
    ...
    HashMap<Integer, Integer> map =
        new HashMap<Integer, Integer>(128); // offsetAddr----index of operate
    int iOfOper = 0;
  ...
  private Command cmd_music =
      new Command() {
        ...
        @Override
        public Operate getOperate(final byte[] code, final int start) {
          System.out.println("cmdMusic");
          return null;
        }
      };

  private Command cmd_loadmap =
      new Command() {
        ...
        public Operate getOperate(final byte[] code, final int start) {
          ...
          System.out.println(
              String.format("loadMap【type:%d index:%d x:%d y:%d】", type, index, x, y));
  ...
  private Command cmd_createactor =
      new Command() {
        ...
        public Operate getOperate(final byte[] code, final int start) {
          System.out.printf(
              "createActor【%d, %d, %d】\n",
              get2ByteInt(code, start), get2ByteInt(code, start + 2), get2ByteInt(code, start + 4));
          return new OperateDrawOnce() {

            @Override
            public boolean process() {
              mScreenMainGame.createActor(
                  get2ByteInt(code, start),
  ...
  private Command cmd_move =
      new Command() {
        ...
        public Operate getOperate(final byte[] code, final int start) {
          System.out.printf(
              "cmdMove【NPC:%s, dstX:%d, dstY:%d】\n",
              mScreenMainGame.getNPC(get2ByteInt(code, start)).toString(),
              get2ByteInt(code, start + 2),
              get2ByteInt(code, start + 4));
          return new Operate() {
            long time = 400;
  ...
  private Command cmd_goto =
      new Command() {
        ...
        @Override
        public Operate getOperate(final byte[] code, final int start) {
          System.out.println("goto:" + get2ByteInt(code, start));
          return new OperateAdapter() {
  ...
  private Command cmd_if =
      new Command() {
        ...
        public Operate getOperate(final byte[] code, final int start) {
          System.out.println(
              "if:" + get2ByteInt(code, start) + " goto:" + get2ByteInt(code, start + 2));
          return new OperateAdapter() {
  ...
  private Command cmd_set =
      new Command() {
        ...
        public Operate getOperate(final byte[] code, final int start) {
          System.out.println(
              "set:" + get2ByteInt(code, start) + "=" + get2ByteInt(code, start + 2));
          return new OperateAdapter() {
  ...
  private Command cmd_say =
      new Command() {
        ...
        public Operate getOperate(final byte[] code, final int start) {
          System.out.printf(
              "say【%d,txt: %s】\n",
              get2ByteInt(code, start), getStringBytes(code, start + 2).toString());
          return new Operate() {
  ...
  private Command cmd_startchapter =
      new Command() {
        ...
        @Override
        public Operate getOperate(final byte[] code, final int start) {
          var type = ((int) code[start] & 0xFF) | ((int) code[start + 1] << 8 & 0xFF);
          var index = ((int) code[start + 2] & 0xFF) | ((int) code[start + 3] << 8 & 0xFF);
          System.out.println("startChapter:" + type + " " + index);
          return new OperateAdapter() {
            int type, index;
      ...
      new Command() {
        ...
        public Operate getOperate(final byte[] code, final int start) {
          ...
          return new OperateAdapter() {
            ...
            @Override
            public boolean process() {
              mScreenMainGame.setMapScreenPos(
                  get2ByteInt(code, start), get2ByteInt(code, start + 2));
              return false;
            }
          };
  ...
  // 伏魔记未用到
  private Command cmd_setcontrolid =
      new Command() {
  ...
  private Command cmd_setevent =
      new Command() {
        ...
        @Override
        public Operate getOperate(final byte[] code, final int start) {
          System.out.printf("setEvent【%d】", get2ByteInt(code, start));
          return new OperateAdapter() {
  ...
  private Command cmd_clrevent =
      new Command() {
        ...
        @Override
        public Operate getOperate(final byte[] code, final int start) {
          System.out.printf("clrEvent【%d】", get2ByteInt(code, start));
          return new OperateAdapter() {
  ...
  private Command cmd_facetoface =
      new Command() {
  ...
  private Command cmd_gaingoods =
      new Command() {
        ...
        @Override
        public Operate getOperate(final byte[] code, final int start) {
          System.out.println("gainGoods:");
          return new Operate() {
            BaseGoods goods =
                (BaseGoods)
                    DatLib.GetRes(
                        DatLib.RES_GRS, get2ByteInt(code, start), get2ByteInt(code, start + 2));
  ...
  private Command cmd_fightenable =
      new Command() {
  ...
  private Command cmd_fightdisenable =
      new Command() {
  ...
  private Command cmd_enterfight =
      new Command() {
        ...
        public Operate getOperate(final byte[] code, final int start) {
          return new OperateAdapter() {
            ...
            public boolean process() {
              ...
              Combat.EnterFight(
                  get2ByteInt(code, start), monstersType, scr, evtRnds, evts, lossto, winto);
              mScreenMainGame.exitScript();
              return false;
            }
          };
  ...
  private Command cmd_deleteactor =
      new Command() {
  ...
  private Command cmd_learnmagic =
      new Command() {
  ...
  private Command cmd_npcmovemod =
      new Command() {
  ...
  private Command cmd_deletegoods =
      new Command() {
  ...
  private Command cmd_resumeactorhp =
      new Command() {
  ...
  private Command cmd_actorlayerup =
      new Command() {
  ...
  private Command cmd_setscenename =
      new Command() {
  ...
  private Command cmd_showscenename =
      new Command() {
  ...
  private Command cmd_showscreen =
      new Command() {
  ...
  // 伏魔记未用到
  private Command cmd_attribtest =
      new Command() {
        ...
        public Operate getOperate(final byte[] code, final int start) {
          return new Operate() {
...

            {
              ...
              rect = new Rect(0, imgTop != null ? imgTop.getHeight() : 0, 160, curY);
            }
  ...
  private Command cmd_usegoodsnum =
      new Command() {
  ...
  // 伏魔记未用到
  private Command cmd_callchapter =
      new Command() {
  ...
  // 0-6
  private Command cmd_disablesave =
      new Command() {
  ...
  // 0-6
  private Command cmd_enablesave =
      new Command() {
  ...
  // 伏魔记未用到
  private Command cmd_seteventtimer =
      new Command() {
  ...
  private Command cmd_enableshowpos =
      new Command() {
  ...
  private Command cmd_disableshowpos =
      new Command() {
  ...
  private Command cmd_testgoodsnum =
      new Command() {
        ...
        @Override
        public Operate getOperate(final byte[] code, final int start) {
          System.out.println("testGoodsNum");
          return new OperateAdapter() {

            @Override
            public boolean process() {
              int goodsnum =
                  Player.sGoodsList.getGoodsNum(
                      get2ByteInt(code, start), get2ByteInt(code, start + 2));
